...
const myBookmarkButton = document.getElementById('BookmarkButton');
let bookmarks = JSON.parse(localStorage.getItem('bookmarks')) || [] ; 
 
addBookmarks();

myBookmarkButton.addEventListener('click', (e) => {
    e.preventDefault();
...
function addBookmarks() {
    ...
    bookmarks.forEach((bookmark, index) => {
        ...
        bookmarkDiv.innerHTML = `
            ...
            <div class'editeIcone'>
                <button class="edit" onclick="editBookmark(${index})"><i class="fas fa-edit"></i>Edit</button>
                <button class="delete" onclick="deleteBookmark(${index})"><i class="fas fa-trash"></i>Delete</button>
            </div>
        `;
